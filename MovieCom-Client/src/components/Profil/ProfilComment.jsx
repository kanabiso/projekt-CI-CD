...
function ProfilComment({ id, content, rating, onDelete, movieId }) {
        ...
        <div className=' flex'>
            <div className='float-left'>
                <img
                    ...
                    className='max-w-20 rounded-lg border-2 border-app mx-6 mt-6 mb-1'>
                </img>
                <a href={"/movie/" + movieId} className='font-bold'>To movie</a>
            ...
            <div className='text-left w-full float-left p-3 mt-6 border-2 border-app rounded-lg'>
                ...
                <img
                    ...
                    className='relative   float-right h-8 w-8 bg-red-400 p-2 rounded-md'
